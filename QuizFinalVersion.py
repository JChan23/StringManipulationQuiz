...
def mid(S):
    ...
    if Round == 1:
        ...
        Answer = f'"{S[RandomVariable:RandomLength + RandomVariable]}"'
        ...
        RandomVariable = random.randint(0, l - 1)
        RandomLength = random.randint(1, l - RandomVariable)
        NewString = f'"{S[RandomVariable:RandomLength + RandomVariable]}"'
...
print('3. Remember: characters use single quotation marks whereas strings use double quotation marks')
print('')
